  ...
  return (
    <li className={`todo__item--not-done ${task.done ? "todo__item--done" : ""}`}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        required />
        <input value={editDescription} onChange={ e => setEditDescription(e.target.value)} placeholder="Edit Description"
        required />
      <button className="form__remove-btn" type='submit'>Confirm</button>
      </form>
    </li>
  );
};
