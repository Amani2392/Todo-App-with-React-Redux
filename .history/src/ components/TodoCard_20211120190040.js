...
const TodoCard = ({ task }) => {
  ...
  const handleEditForm = () => {
    const selectForm = document.getElementsByClassName("edit-form");
    selectForm.classList.add("render-edit-form");
  };
  ...
  return (
    ...
    >
      ...
      <button className="form__remove-btn" onClick={handleEditForm}>
        Edit
      </button>
